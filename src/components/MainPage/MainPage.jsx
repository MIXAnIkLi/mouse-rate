    ...
    <div className="body">
      <div className="content">
        ...
        <div className="content__text">
          <div className="content__text-withotq">
          {" "}
          ...
          <p className="content_paragraph">
            ...
            финансовую граммотность <br/> и научиться граммотно управлять своими 
            денежными средствами, чтобы вырваться из крысиных бегов, <br/>достигнув
            своей заветной мечты
          </p>
          </div>
          <p className="content__quote">
          „Большинство людей не понимают, что в жизни важно не то, <br/>сколько денег вы зарабатываете, а то, сколько их у вас остается.“<br/>
